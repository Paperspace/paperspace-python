...
@click.option("--useDockerfile", "useDockerfile", is_flag=True, help="Flag: using Dockerfile")
@click.option("--isPreemptible", "isPreemptible", is_flag=True, help="Flag: isPreemptible")
